...
try
{
    ...
    {
        Write-Output "User-supplied InstallerArgs value: $installerArgsList"
    }
    ...
    elseif ($version -eq '2017')
    {
        ...
        if (-not $installerArgsList)
        {
            ...
            $enterpriseModulesArgsList = $ProfessionalModulesArgsList + @(
        ...
        if ($sku -eq 'Professional')
        {
            $argumentList = $installerArgsList + $commonArgsList + $ProfessionalModulesArgsList
